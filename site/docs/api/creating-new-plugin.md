...
- [Indexing Flow](#indexing-flow)
    * Interfaces for defining a new index - implementations of [Index](../scaladoc/1.2.0/io/xskipper/index/index.html) along with [IndexFactory](../scaladoc/1.2.0/io/xskipper/index/IndexFactory.html).
    * Interface for specifying how to store the metadata in the metadatastore - implementations of [MetaDataTranslator](../scaladoc/1.2.0/io/xskipper/metadatastore/MetaDataTranslator.html).

- [Query Evaluation Flow](#query-evaluation-flow) 
    * Interfaces for defining how query expressions are mapped to abstract conditions on metadata - implementations of [MetaDataFilter](../scaladoc/1.2.0/io/xskipper/search/filters/MetadataFilter.html) along with [MetaDataFilterFactory](../scaladoc/1.2.0/io/xskipper/search/filters/MetadataFilterFactory.html).
    * Interfaces for translating an abstract clause to a specific implementation according to the metadatastore - Implementations of [ClauseTranslator](../scaladoc/1.2.0/io/xskipper/metadatastore/ClauseTranslator.html).
...
To use a plugin, load the relevant implementations using the Registration module ([Scala](../scaladoc/1.2.0/io/xskipper/Registration$.html), [Python](../pythondoc/1.2.0/index.html#module-xskipper.registration)).   
For example:
...
*Implementation(s) of [MetaDataType](../scaladoc/1.2.0/io/xskipper/index/metadata/MetadataType.html)*
...
*Implementation(s) of [Index](../scaladoc/1.2.0/io/xskipper/index/index.html) along with [IndexFactory](../scaladoc/1.2.0/io/xskipper/index/IndexFactory.html)*

Support for new indexes can be achieved by implementing a new class that implements the [Index](../scaladoc/1.2.0/io/xskipper/index/index.html) abstract class.  
...
Along with the Index you need to define an [IndexFactory](../scaladoc/1.2.0/io/xskipper/index/IndexFactory.html) - 
...
*Implementation(s) of [MetaDataTranslator](../scaladoc/1.2.0/io/xskipper/metadatastore/MetaDataTranslator.html)*
...
To do so you have 2 options:
    ...
    * Use the default java serialization provided by the parquet metadata store. To do so you need to define the UDT and register it. For example, for bloom filter, we use the following definition to get the default java serialization:
    ...
    Then register the UDT to Spark using the [ParquetMetadataStoreUDTRegistration](../scaladoc/1.2.0/org/apache/spark/sql/types/ParquetMetadataStoreUDTRegistration$.html) object:
    ```Scala
...
*Implementations of [Clause](../scaladoc/1.2.0/io/xskipper/search/clause/Clause.html)*
...
*Implementation(s) of [MetaDataFilter](../scaladoc/1.2.0/io/xskipper/search/filters/MetadataFilter.html) along with [MetaDataFilterFactory](../scaladoc/1.2.0/io/xskipper/search/filters/MetadataFilterFactory.html)*
...
Along with a Filter you need to define a [MetadataFilterFactory](../scaladoc/1.2.0/io/xskipper/search/filters/MetadataFilterFactory.html). The MetadataFilterFactory specifies which filters should run given the available indexes.
...
*Implementations of [ClauseTranslator](../scaladoc/1.2.0/io/xskipper/metadatastore/ClauseTranslator.html)*
