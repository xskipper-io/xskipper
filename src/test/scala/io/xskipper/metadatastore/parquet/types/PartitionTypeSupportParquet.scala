...
class PartitionTypeSupportParquetV1 extends PartitionTypeSupportParquet(false)

class PartitionTypeSupportParquetV2 extends PartitionTypeSupportParquet(true)
